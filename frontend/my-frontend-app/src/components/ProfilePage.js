            ...
            <div className="flex content-center justify-center">
                ...
                <div className="w-6/12 bg-sky-200 min-h-screen p-12 flex flex-col justify-center content-center">
                    <div className="m-auto"> 
                        ...
                        <p>{bio}</p>
                        <button onClick={() => handleLogout()} type="button" className="mt-10 p-3 bg-red-700 text-white cursor-pointer hover:bg-red-900 duration-200" style={{maxWidth: "200px"}}>Log Out</button>
                    </div>  
                </div>
            </div>
        </div>
