      ...
      <div className="container mx-auto ">
        <div className="my-8 flex flex-row gap-x-32 content-center justify-center">
            ...
            <div className="justify-center flex flex-col align-center text-left max-w-3xl" >
                <h3> id="smartmatch"{'>'}Smartmatch</h3>
                <span role="img" aria-labelledby="smartmatch">💘</span>
                <h1 className="pb-6">Let smartmatch find you the best match for you today!</h1>
                <form className="flex flex-col align-start" onSubmit={(e) => handleLogin(e)}>
                    ...
                    <div>
                        ...
                        <button onClick={() => navigate.push("/create-account")} type="button" className="ml-6 p-3 bg-sky-600 text-white mt-5 cursor-pointer hover:bg-sky-900 duration-200" style={{maxWidth: "200px"}}>Create Account</button>
                    </div>
                </form>
            </div>
        </div>   
